    ...
    <div className="container">
      ...
      <div className="phase1Container">
        ...
        <div className="phase1_Contents">
          <h2 className="phase1Title">Buy-back</h2>

          <div className="phase1Info">
            <p>
              10,000,000,000 (10% of total supply) will be used to buy back
              insuring that the project doesn't go back <br /> to launch price.
              This will be sold at any point in the project and and it will be
              held in <strong> USDC</strong> and buyback <br /> be take place
              once the price of $POO is nearing it's launch price and will never
              be sold afterward <br /> (but if price go beyond high beyond
              launch price the remaining usdc will be added to liquidity or used
              for <br /> marketing depending on the teams suggestions){" "}
              <strong>NOTE: This will happen only once in the project.</strong>
            </p>
          </div>
        </div>
      </div>

      {/* Next button to load the Buy-back page */}
      <div className="RoadMaps_phase">
        <div className="nav_btns">
          <button id="RoadmapBtn" onClick={load_Airdrop}>
            <div>
              <small>Next</small>
              <p>Airdrop</p>
            </div>
          ...
          <button id="IntroBtn" onClick={load_Governance}>
            <div className="nextIcon">
