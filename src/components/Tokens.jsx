  ...
  return (
    <div className="container">
      <div className="nav">
        ...
        <div className="nav_links">
          <ul>
            ...
            <li>
              <button load_Staking >Staking</button>
            </li>
            <li>
              <button onClick={load_Governance} >Governance</button>
            </li>
      ...
      <div className="tokenomics_container">
        <div className="tokensHolder"></div>

        <div className="tokensContents">
          <h2 className="tokensTitle">Tokenomics</h2>
          ...
          <div className="tokenInfo">
            ...
            <p>
              <strong>Liquidity:</strong> 20%{" "}
            </p>
            <p>
              <strong>Presale and Airdrop:</strong> 50%{" "}
            </p>
            <p>
              <strong>Buy back:</strong> 10%{" "}
            </p>
            <p>
              <strong>Staking:</strong> 10%{" "}
            </p>
            <p>
        ...
        {/* Next button to load the Roadmap page */}
        <div className="tokenNext">
          <div className="nav_btns">
            <button id="RoadmapBtn" onClick={navigate_phase1}>
              <div>
                <small>Next</small>
                <p>Phase 1</p>
              </div>
            ...
            <button id="IntroBtn" onClick={navigate_ToIntro}>
              <div className="nextIcon">
