...
const Phase4 = () => {
  ...
  return (
    <div className="container">
      ...
      {/* Start Roadmap - Phase 4 */}

      <div className="phase1Container">
        <div className="phase1holder"></div>
        <div className="phase1_Contents">
          <h2 className="phase1Title">Phase 4</h2>

          <div className="phase1Info">
            <ol>
              <li> More marketing and promotion</li>
              <li>Reaching out to DAO's and whales to buy out</li>
              <li>Burning and buy back</li>
              <li> Community decides whether to run an NFT project</li>
            </ol>
          </div>
        </div>
      </div>

      {/* Next button to load the Phase 4 page */}
      <div className="RoadMaps_phase">
        <div className="nav_btns">
          <button id="RoadmapBtn" onClick={load_presale}>
            <div>
              <small>Next</small>
              <p>Pre-sale</p>
            </div>
          ...
          <button id="IntroBtn" onClick={navigate_phase3}>
            <div className="nextIcon">
