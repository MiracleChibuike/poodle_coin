    ...
    <div className="container">
      ...
      <div className="phase1Container">
        ...
        <div className="phase1_Contents">
          <h2 className="phase1Title">Rewards Distribution</h2>

          <div className="phase1Info">
            <p>
              Pre-sale distribution will happen before launch which will be only
              50% of pre-sale purchase. Date for the <br /> reminder (50%) will
              be communicated after launch . Staking rewards will be distributed
              proportionally <br /> based on the amount of poodle staked by each
              participant. This encourages long-term commitment <br /> and
              active participation within the Steal Coin community.
            </p>
          </div>
        </div>
      </div>

      {/* Next button to load the Conclusion page */}
      <div className="RoadMaps_phase">
        <div className="nav_btns">
          <button id="RoadmapBtn" onClick={load_Conclusion}>
            <div>
              <small>Next</small>
              <p>Conclusion</p>
            </div>
          ...
          <button id="IntroBtn" onClick={load_Airdrop}>
            <div className="nextIcon">
