    ...
    <div className="container">
      ...
      <div className="phase1Container">
        ...
        <div className="phase1_Contents">
          <h2 className="phase1Title">Pre-sale</h2>

          <div className="phase1Info">
            <p>
              Presale rewards early supporter a chance to buy $POO at a
              discounted rate. Which funds raised from presale <br /> will be
              used for marketing, liquidity pool formation and staking pool
              liquidity
            </p>
          </div>
        </div>
      ...
      {/* Next button to load the Pre-sale page */}
      <div className="RoadMaps_phase">
        <div className="nav_btns">
          <button id="RoadmapBtn" onClick={load_Staking}>
            <div>
              <small>Next</small>
              <p>Staking</p>
            </div>
          ...
          <button id="IntroBtn" onClick={navigate_phase4}>
            <div className="nextIcon">
