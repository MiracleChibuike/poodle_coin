    ...
    <div className="container">
      ...
      <div className="phase1Container">
        ...
        <div className="phase1_Contents">
          <h2 className="phase1Title">Staking</h2>

          <div className="phase1Info">
            <p>
              Poodle introduces a robust staking mechanism where holders can
              lock their tokens in the staking pool to earn <br /> additional
              rewards in $POO and Solana coins. Stakers contribute to the
              stability and security of the network <br /> while being
              incentivized for their commitment. Which will bring about
              effective and efficient utility into the <br /> project (a very
              huge worthy of solana and 10% of total supply) will be used for
              staking after liquidity has <br /> been exhausted liquidity pool
              is closed forever.
            </p>
          </div>
        </div>
      ...
      {/* Next button to load the Staking page */}
      <div className="RoadMaps_phase">
        <div className="nav_btns">
          <button id="RoadmapBtn" onClick={load_Governance}>
            <div>
              <small>Next</small>
              <p>Governance</p>
            </div>
          ...
          <button id="IntroBtn" onClick={load_presale}>
            <div className="nextIcon">
