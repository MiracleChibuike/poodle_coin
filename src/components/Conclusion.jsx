...
import conclusion_image from "../assets/images/Conclusion.jpeg"
  ...
  return (
    <div className="container">
      ...
      <div className="phase1Container">
        <div className="conclusion_Img_Holder"></div>
        <div className="phase1_Contents">
          <h2 className="phase1Title">Conclusion</h2>

          <div className="phase1Info">
            <p>
              Poodle is not just a meme coin,it's a community-driven project on
              the Solana blockchain with a vision to redefine the meme coin
              landscape. By combining presale, airdrop, and staking mechanisms,
              Poodle aims to create a sustainable and rewarding ecosystem that
              stands out in the decentralized finance space.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="RoadMaps_phase">
        <div className="nav_btns">
          <button id="IntroBtn" onClick={load_Rewards}>
