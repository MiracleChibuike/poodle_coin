...
const WhiteP = () => {
  ...
  return (
    <div className="Container">
        ...
        <div className="nav_Secondary">
          <div className="nav_links_Sec">
            <ul>
              <li>
                {" "}
                <button id="active_link">Introduction</button>{" "}
              </li>
              <li>
                {" "}
              ...
              <li>
                ...
                <div className="drops">
                  <ul>
                    ...
                    <li>
                      <button onClick={nav_phase3}>Phase 3</button>
                    </li>
                    <li>
                      <button onClick={nav_phase4}>Phase 4</button>
                    </li>
                  </ul>
                </div>
              </li>
      ...
      <div className="home">
        <div className="introHolder"></div>

        <div className="home_contents">
          <h2 className="home_Title">Introduction</h2>
          <p>
            Poodle Coin is designed to inject innovation into the meme coin
            space by leveraging the speed and efficiency of the Solana
            blockchain. <br /> The project aims to provide a transparent,
            secure, airdrop along with high staking rewards for $POO stakers but
            with $POO and solana and <br /> rewarding experience for its
            community members.
          </p>
        </div>
      </div>

      {/* Next Button/ To launch the next component */}

      <div className="next_Tokenomics">
        <button id="TokensBtn" onClick={Tokens_Nav}>
          <div>
            <small>Next</small>
            <p>Tokenomics</p>
          </div>
