    ...
    <div className="container">
      ...
      <div className="phase1Container">
        ...
        <div className="phase1_Contents">
          <h2 className="phase1Title">Phase 2</h2>

          <div className="phase1Info">
            <ol>
              <li>
                {" "}
                Preparation of presale and launch (community decides on which
                decentralised exchanges to list)
              </li>
              <li>Presale</li>
              <li>Distribution of presale prior to launch</li>
              <li>
                Launch of $poodle token and airdrops to qualified individuals
                and presale partakers
              </li>
            </ol>
          </div>
        </div>
      </div>
      {/* Next button to load the Phase 3 page */}
      <div className="RoadMaps_phase">
        <div className="nav_btns">
          <button id="RoadmapBtn" onClick={navigate_phase3}>
            <div>
              <small>Next</small>
              <p>Phase 3</p>
            </div>
          ...
          <button id="IntroBtn" onClick={navigate_phase1}>
            <div className="nextIcon">
