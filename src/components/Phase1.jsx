...
const Phase1 = () => {
  ...
  return (
    <div className="container">
      ...
      {/* End Nav */}
      {/* Start Roadmap - Phase 1 */}

      <div className="phase1Container">
        <div className="phase1holder"></div>
        <div className="phase1_Contents">
          <h2 className="phase1Title">Phase 1</h2>

          <div className="phase1Info">
            <ol>
              <li>
                {" "}
                Gathering of team and setting up project social media handle
              </li>
              <li>Launch of tokenomics, and roadmap white paper</li>
              <li>Partnership with project and possible AMA</li>
              <li>Launch of website</li>
            </ol>
          </div>
        </div>
      </div>
      {/* Next button to load the Phase 2 page */}
      <div className="RoadMaps_phase">
        <div className="nav_btns">
          <button id="RoadmapBtn" onClick={navigate_phase2}>
            <div>
              <small>Next</small>
              <p>Phase 2</p>
            </div>
          ...
          <button id="IntroBtn" onClick={Tokens_Nav}>
            <div className="nextIcon">
