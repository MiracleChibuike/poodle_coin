...
const Phase3 = () => {
  ...
  return (
    <div className="container">
      ...
      {/* Start Roadmap - Phase 3 */}

      <div className="phase1Container">
        <div className="phase1holder"></div>
        <div className="phase1_Contents">
          <h2 className="phase1Title">Phase 3</h2>

          <div className="phase1Info">
            <ol>
              <li>
                {" "}
                Launch of staking protocol on radyium which includes sol rewards
                for stakers
              </li>
              <li>Listing on CMC</li>
              <li>First pump by the project Dev</li>
              <li>More collabs to get investors</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div className="RoadMaps_phase">
        <div className="nav_btns">
          <button id="RoadmapBtn" onClick={navigate_phase4}>
            <div>
              <small>Next</small>
              <p>Phase 4</p>
            </div>
          ...
          <button id="IntroBtn" onClick={navigate_phase2}>
            <div className="nextIcon">
