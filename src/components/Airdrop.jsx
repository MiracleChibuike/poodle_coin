    ...
    <div className="Container">
      ...
      <div className="phase1Container">
        ...
        <div className="phase1_Contents">
          <h2 className="phase1Title">Airdrop</h2>

          <div className="phase1Info">
            <p>
              To insure widespread distribution and inclusivity, airdrop will be
              held among Early supporter <br /> (people who participated in
              presale) . This airdrop is to insure distribution of token and
              promotes <br />
              engagement from the community . Airdrop will be given to early
              supporters and reward will be <br /> in $POO which will come along
              side Pre-sale(50% will be released at TGE).
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="RoadMaps_phase">
        <div className="nav_btns">
          <button id="RoadmapBtn" onClick={load_rewards}>
            <div>
              <small>Next</small>
          ...
          <button id="IntroBtn" onClick={LoadBuy_back}>
            <div className="nextIcon">
